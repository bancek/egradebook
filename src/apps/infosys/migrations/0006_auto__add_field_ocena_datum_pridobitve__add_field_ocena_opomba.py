...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ocena.datum_pridobitve'
        db.add_column('infosys_ocena', 'datum_pridobitve', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'Ocena.opomba'
        db.add_column('infosys_ocena', 'opomba', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Ocena.datum_pridobitve'
        db.delete_column('infosys_ocena', 'datum_pridobitve')

        # Deleting field 'Ocena.opomba'
        db.delete_column('infosys_ocena', 'opomba')
    ...
    models = {
        ...
        'infosys.ocena': {
            ...
            'datum_pridobitve': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
