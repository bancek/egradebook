...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profesor.ime'
        db.delete_column('infosys_profesor', 'ime')

        # Deleting field 'Profesor.priimek'
        db.delete_column('infosys_profesor', 'priimek')

        # Deleting field 'Stars.ime'
        db.delete_column('infosys_stars', 'ime')

        # Deleting field 'Stars.priimek'
        db.delete_column('infosys_stars', 'priimek')

        # Deleting field 'Dijak.ime'
        db.delete_column('infosys_dijak', 'ime')

        # Deleting field 'Dijak.priimek'
        db.delete_column('infosys_dijak', 'priimek')

    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Profesor.ime'
        raise RuntimeError("Cannot reverse this migration. 'Profesor.ime' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Profesor.priimek'
        raise RuntimeError("Cannot reverse this migration. 'Profesor.priimek' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Stars.ime'
        raise RuntimeError("Cannot reverse this migration. 'Stars.ime' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Stars.priimek'
        raise RuntimeError("Cannot reverse this migration. 'Stars.priimek' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Dijak.ime'
        raise RuntimeError("Cannot reverse this migration. 'Dijak.ime' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Dijak.priimek'
        raise RuntimeError("Cannot reverse this migration. 'Dijak.priimek' and its values cannot be restored.")
