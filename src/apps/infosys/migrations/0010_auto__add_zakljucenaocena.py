...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ZakljucenaOcena'
        db.create_table('infosys_zakljucenaocena', (
            ...
            ('datum_vnosa', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('datum_spremembe', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('datum_pridobitve', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('infosys', ['ZakljucenaOcena'])

    def backwards(self, orm):
        
        # Deleting model 'ZakljucenaOcena'
        db.delete_table('infosys_zakljucenaocena')
