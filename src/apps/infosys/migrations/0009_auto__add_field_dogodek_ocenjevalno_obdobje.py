...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dogodek.ocenjevalno_obdobje'
        db.add_column('infosys_dogodek', 'ocenjevalno_obdobje', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['infosys.OcenjevalnoObdobje']), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Dogodek.ocenjevalno_obdobje'
        db.delete_column('infosys_dogodek', 'ocenjevalno_obdobje_id')
