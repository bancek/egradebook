...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SolskoLeto.aktivno'
        db.add_column('infosys_solskoleto', 'aktivno', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'SolskoLeto.aktivno'
        db.delete_column('infosys_solskoleto', 'aktivno')
