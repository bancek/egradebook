...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ocena.dogodek'
        db.add_column('infosys_ocena', 'dogodek', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['infosys.Dogodek'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Ocena.dogodek'
        db.delete_column('infosys_ocena', 'dogodek_id')
