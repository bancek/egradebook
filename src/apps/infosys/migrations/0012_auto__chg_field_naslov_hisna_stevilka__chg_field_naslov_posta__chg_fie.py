...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Naslov.hisna_stevilka'
        db.alter_column('infosys_naslov', 'hisna_stevilka', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Naslov.posta'
        db.alter_column('infosys_naslov', 'posta', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Naslov.kraj'
        db.alter_column('infosys_naslov', 'kraj', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Naslov.ulica'
        db.alter_column('infosys_naslov', 'ulica', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        
        # Changing field 'Naslov.hisna_stevilka'
        db.alter_column('infosys_naslov', 'hisna_stevilka', self.gf('django.db.models.fields.CharField')(default=0, max_length=5))

        # Changing field 'Naslov.posta'
        db.alter_column('infosys_naslov', 'posta', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0))

        # Changing field 'Naslov.kraj'
        db.alter_column('infosys_naslov', 'kraj', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Naslov.ulica'
        db.alter_column('infosys_naslov', 'ulica', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        'infosys.dogodek': {
            'Meta': {'ordering': "('datum',)", 'object_name': 'Dogodek'},
        ...
        'infosys.naslov': {
            ...
            'hisna_stevilka': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kraj': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'posta': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'ulica': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'infosys.ocena': {
            ...
            'dogodek': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['infosys.Dogodek']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'infosys.zakljucenaocena': {
            'Meta': {'object_name': 'ZakljucenaOcena'},
            'datum_pridobitve': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'datum_spremembe': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'datum_vnosa': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dijak': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['infosys.Dijak']"}),
