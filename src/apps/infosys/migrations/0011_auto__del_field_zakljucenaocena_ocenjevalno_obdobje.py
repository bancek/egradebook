...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ZakljucenaOcena.ocenjevalno_obdobje'
        db.delete_column('infosys_zakljucenaocena', 'ocenjevalno_obdobje_id')

    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ZakljucenaOcena.ocenjevalno_obdobje'
        raise RuntimeError("Cannot reverse this migration. 'ZakljucenaOcena.ocenjevalno_obdobje' and its values cannot be restored.")
